...
class PromotionCleanupTaskHandler extends ScheduledTaskHandler
{
    ...
    public function run(): void
    {
        ...
        $enabled = $config['ICTECHDataCleanerPro.config.enableSchedulerOfPromotions'] ?? false;
        $frequency = $config['ICTECHDataCleanerPro.config.promotionCleanupScheduleFrequency'] ?? 'weekly';
