...
class MediaCleanupTaskHandler extends ScheduledTaskHandler
{
    ...
    public function run(): void
    {
        ...
        $enabled = $config['ICTECHDataCleanerPro.config.enableSchedulerOfMedia'] ?? false;
        $frequency = $config['ICTECHDataCleanerPro.config.mediaCleanupScheduleFrequency'] ?? 'weekly';
        ...
        $this->systemConfigService->set(
            'ICTECHDataCleanerPro.config.mediaCleanupLastRun',
