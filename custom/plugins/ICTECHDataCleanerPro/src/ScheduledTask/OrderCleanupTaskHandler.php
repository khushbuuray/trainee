...
class OrderCleanupTaskHandler extends ScheduledTaskHandler
{
    ...
    public function run(): void
    {
        ...
        $enabled = $config['ICTECHDataCleanerPro.config.enableSchedulerOfOrders'] ?? false;
        $frequency = $config['ICTECHDataCleanerPro.config.orderCleanupScheduleFrequency'] ?? 'weekly';
